...
#### Docs and packaging
- Expanded `README.md` (crawler options, disk layout, focused content, RAG flows for file and DB, catalog vs Chroma/Qdrant, `--config` YAML, review).
- Plans/tasks: `IMPLEMENTATION_TASK.md`, `RAG_IMPLEMENTATION_PLAN.md`, `REVIEW_RAG_IMPLEMENTATION_PLAN.md`, `REVIEW_RAG_TASK.md`, `CONTENT_EXTRACTION_IMPLEMENTATION_PLAN.md`, `CONTENT_EXTRACTION_TASK.md`.
